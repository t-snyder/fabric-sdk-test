...
public class KafkaProducerTest
{
  ...
  /**
   * Initialize the Kafka Producer prior to sending messages. Note the properties must match with the sdk-wrapper properties.
   * 
   * @param runtimeMgr
   */
  public KafkaProducerTest( ConfigProperties orgProps )
  {
